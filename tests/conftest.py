...
def tmp_env(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> Settings:
    ...
    monkeypatch.setenv("TRANSITION_ANALYSIS_FPS", "8")
    monkeypatch.setenv("TRANSITION_SEARCH_START_RATIO", "0.35")
    monkeypatch.setenv("TRANSITION_SEARCH_END_RATIO", "0.70")
    monkeypatch.setenv("TRANSITION_MIN_SECONDS_FROM_EDGE", "0.75")
    monkeypatch.setenv("TRANSITION_CONFIDENCE_THRESHOLD", "0.08")
    monkeypatch.setenv("TRANSITION_CROSSFADE_SECONDS", "0.12")
    monkeypatch.setenv("FINAL_VIDEO_MAX_DURATION_SECONDS", "8")
    monkeypatch.setenv("FINAL_VIDEO_MAX_PIXELS", "5000000")
    monkeypatch.setenv("FINAL_VIDEO_MAX_FPS", "60")
    monkeypatch.setenv("FINAL_VIDEO_FFMPEG_TIMEOUT_SECONDS", "180")
    monkeypatch.setenv("FINAL_VIDEO_MAX_INPUT_DURATION_DELTA_SECONDS", "0.35")
    monkeypatch.setenv("FINAL_VIDEO_MAX_DIMENSION_DELTA_PIXELS", "8")
